...
/**
 * Database entity representing boundaries on the map.
 */
...
public class Boundary {
    ...
    Boundary(int id, @NonNull String type, int left, int top, int right, int bottom, int floor, int cell_id_1,
             int cell_id_2) {
        this.id = id;
        this.left = left;
        this.top = top;
    ...
    int getCell_id_1() { return cell_id_1; }
    int getCell_id_2() { return cell_id_2; }
