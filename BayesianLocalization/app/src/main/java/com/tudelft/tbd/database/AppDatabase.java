...
/**
 * Class containing Data Access Objects to required tables in the database
 * Reference: https://developer.android.com/training/data-storage/room/index.html
 */

@Database(entities = {TrainingMeasurement.class, Measurement.class, Cell.class,
        Boundary.class}, version = 1)
